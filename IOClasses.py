...
# Jurg Huerlimann 2020-Sep-07, skillfully copied the code from FDN_Py_Module_09.pdf appendix
# Jurg Huerlimann 2020-Sep-08  fixed my not so skillful mistake with block indents
# Jurg Huerlimann 2020-Sep-08  added error check for track input
# Jurg Huerlimann 2020-Sep-09  minor fixes, typos  
#------------------------------------------#
...
class ScreenIO:
    ...
    def print_CD_menu():
        ...
        print('CD Sub Menu\n\n[a] Add track\n[d] Display cd / Album details\n[r] Remove track\exit to Main Menu')
    ...
    def menu_CD_choice():
        ...
        Returns:
        choice (string): a lower case sting of the users input out of the choices a, d, r
